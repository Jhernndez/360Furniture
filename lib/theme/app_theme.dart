...
/// A class that contains all theme configurations for the service management application.
/// Implements Professional Minimalism design style with Operational Clarity color theme
/// optimized for field technicians and business administrators.
class AppTheme {
  AppTheme._();

  // Operational Clarity Color Palette - optimized for outdoor visibility and extended mobile use
  ...
  static const Color successLight =
      Color(0xFF059669); // Clear positive feedback
  static const Color warningLight =
      Color(0xFFD97706); // Amber for pending states
  static const Color errorLight =
      Color(0xFFDC2626); // Distinct red for critical alerts
  ...
  static const Color onBackgroundLight =
      Color(0xFF0F172A); // Maximum contrast text
  static const Color onSurfaceLight = Color(0xFF0F172A);
  static const Color onErrorLight = Color(0xFFFFFFFF);
  static const Color onSuccessLight = Color(0xFFFFFFFF);
  static const Color onWarningLight = Color(0xFFFFFFFF);

  // Dark theme colors - maintaining operational clarity in low light
  ...
  // Text colors with high contrast ratios for mobile readability
  ...
  // Border and divider colors - minimal and purposeful
  ...
  // Shadow colors for minimal elevation system (0dp, 2dp, 8dp)
  static const Color shadowLight = Color(0x1A000000); // 0.1 opacity maximum
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      elevation: 2.0, // Minimal elevation system
    ...
    bottomNavigationBarTheme: BottomNavigationBarThemeData(
      ...
      elevation: 8.0, // Higher elevation for clear separation
    ...
    // Input decoration optimized for quick data entry
  ...
  /// Dark theme optimized for low light conditions while maintaining operational clarity
  ...
  /// Optimized for mobile readability with balanced character spacing
  ...
  /// Uses JetBrains Mono for numerical data and order numbers
